(function () {
    ...
    // Microsoft Clarity (Vigilant Voices)
    if (typeof window.clarity !== 'function' && !window.__vvClarityInitialized) {
        window.__vvClarityInitialized = true;
        ...
        })(window, document, "clarity", "script", "w8fsj18k5k");
    }
