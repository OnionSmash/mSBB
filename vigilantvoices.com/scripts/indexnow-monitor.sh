...
KEY="a3f9b2d1-7c48-4e9a-9f6b-2d8c1e4f7a92"
KEY_LOCATION="https://${HOST}/${KEY}.txt"
API_URL="https://api.indexnow.org/indexnow"
TEST_URL="https://${HOST}/"
SITEMAP_URL="https://${HOST}/sitemap.xml"
SUBMISSION_LOG="/var/www/vigilantvoices.com/scripts/logs/indexnow-submissions.log"
CRON_LOG="/var/www/vigilantvoices.com/scripts/logs/indexnow-cron.log"
...
import urllib.parse
print(urllib.parse.quote('https://vigilantvoices.com/', safe=''))
PY
)
GET_ENDPOINT="${API_URL}?url=${ENCODED_TEST_URL}&key=${KEY}&keyLocation=$(python3 - <<'PY'
import urllib.parse
print(urllib.parse.quote('https://vigilantvoices.com/a3f9b2d1-7c48-4e9a-9f6b-2d8c1e4f7a92.txt', safe=''))
PY
)"
...
path = '/var/www/vigilantvoices.com/scripts/logs/indexnow-submissions.log'
