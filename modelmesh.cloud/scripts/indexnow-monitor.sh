...
HOST="modelmesh.cloud"
KEY="4f8a1b2c-9d3e-4a7b-bf6e-7d2c5a91e8f0-1a2b3c4d5e6f7g8h9i0j1k2l3m4n5o6"
KEY_LOCATION="https://${HOST}/${KEY}.txt"
API_URL="https://api.indexnow.org/indexnow"
TEST_URL="https://${HOST}/"
SITEMAP_URL="https://${HOST}/sitemap.xml"
SUBMISSION_LOG="/var/www/modelmesh.cloud/scripts/logs/indexnow-submissions.log"
CRON_LOG="/var/www/modelmesh.cloud/scripts/logs/indexnow-cron.log"
...
import urllib.parse
print(urllib.parse.quote('https://modelmesh.cloud/', safe=''))
PY
)
GET_ENDPOINT="${API_URL}?url=${ENCODED_TEST_URL}&key=${KEY}&keyLocation=$(python3 - <<'PY'
import urllib.parse
print(urllib.parse.quote('https://modelmesh.cloud/4f8a1b2c-9d3e-4a7b-bf6e-7d2c5a91e8f0-1a2b3c4d5e6f7g8h9i0j1k2l3m4n5o6.txt', safe=''))
PY
)"
...
path = '/var/www/modelmesh.cloud/scripts/logs/indexnow-submissions.log'
