#!/usr/bin/env python3
"""IndexNow submission utility for modelmesh.cloud.
...
API_KEY = "4f8a1b2c-9d3e-4a7b-bf6e-7d2c5a91e8f0-1a2b3c4d5e6f7g8h9i0j1k2l3m4n5o6"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Submit modelmesh.cloud URLs to IndexNow")
    parser.add_argument(
        "--dry-run",
        action="store_true",
